...
from mongoeco.core.aggregation import Pipeline  # noqa: TC001 - runtime public annotations
...
from mongoeco.engines.base import AsyncStorageEngine  # noqa: TC001 - runtime public annotations
...
class AsyncCollection:
    ...
    def _from_validated_engine(
        ...
        **kwargs: object,
        ...
        collection._validated_engine_spi = engine_spi
        collection.__init__(
            engine,
            db_name,
            collection_name,
    ...
    def _new_collection(
        ...
        **kwargs: object,
        ...
        engine_spi = getattr(self, "_validated_engine_spi", None)
        if engine_spi is None:
            return type(self)(
                self._engine,
                self._db_name,
                collection_name,
        ...
        return type(self)._from_validated_engine(
            engine_spi,
            self._engine,
            self._db_name,
            collection_name,
    ...
    def _new_operation_context(
        ...
        *,
        ...
        if expressions is None and isinstance(bindings, ExpressionExecutionContext):
    ...
    def _require_write_requests(requests: object) -> list[WriteModel]:
        ...
        return [normalize_bulk_write_request(request) for request in raw_requests]
    ...
    def _apply_codec_options_to_document(self, document: Document) -> Document:
        materialized = materialize_public_document(
            document,
            codec_options=self._codec_options,
        )
    ...
    async def insert_one(
        ...
        *,
        ...
        return InsertOneResult(inserted_id=DocumentCodec.to_pymongo(doc["_id"]))
    ...
    async def insert_many(
        ...
        *,
        ...
        return InsertManyResult(
            inserted_ids=[
                DocumentCodec.to_pymongo(document_id) for document_id in inserted_ids
            ]
        )
    ...
    def aggregate(
        ...
        **kwargs: object,
        ...
        return self._build_aggregation_cursor(operation, session=options.get("session"))
    ...
    def database(self):
        ...
        database._validated_engine_spi = getattr(
            self,
            "_validated_engine_spi",
            None,
        )
        return database
