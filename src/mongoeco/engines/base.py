...
class AsyncIndexAdminEngine(Protocol):
    async def create_index(self, db_name: str, coll_name: str, keys: IndexKeySpec, *, unique: bool = False, name: str | None = None, sparse: bool = False, hidden: bool = False, collation: Filter | None = None, partial_filter_expression: Filter | None = None, expire_after_seconds: int | None = None, max_time_ms: int | None = None, context: ClientSession | None = None) -> str: ...
