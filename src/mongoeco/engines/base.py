...
class AsyncExplainEngine(Protocol):
    async def explain_query_plan(self, db_name: str, coll_name: str, filter_spec: Filter | None = None, *, plan: QueryNode | None = None, sort: SortSpec | None = None, skip: int = 0, limit: int | None = None, hint: str | IndexKeySpec | None = None, dialect: MongoDialect | None = None, context: ClientSession | None = None) -> dict[str, object]: ...
