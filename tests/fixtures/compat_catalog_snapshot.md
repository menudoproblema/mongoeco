...
- `stageOptions`: `{'count': ['total', 'lowerBound'], 'highlight': {'supportsPath': True, 'supportsMaxChars': True, 'resultField': 'searchHighlights'}, 'facet': {'supportsPath': True, 'supportsNumBuckets': True, 'supportsType': True, 'supportedTypes': ['string', 'number', 'date'], 'supportsCollectorOperator': True, 'collectorOperatorSupports': ['text', 'phrase', 'autocomplete', 'wildcard', 'regex', 'exists', 'in', 'equals', 'range', 'near', 'compound'], 'previewOnly': True}}`
