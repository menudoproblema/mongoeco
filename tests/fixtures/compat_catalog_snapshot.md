...
- `stageOptions`: `{'count': ['total', 'lowerBound'], 'highlight': {'supportsPath': True, 'supportsMaxChars': True, 'resultField': 'searchHighlights'}, 'facet': {'supportsPath': True, 'supportsNumBuckets': True, 'supportsType': True, 'supportedTypes': ['string', 'number', 'date'], 'previewOnly': True}}`
