...
- `aggregation_stages`: `$addFields`, `$bucket`, `$bucketAuto`, `$collStats`, `$count`, `$currentOp`, `$densify`, `$documents`, `$facet`, `$fill`, `$geoNear`, `$group`, `$indexStats`, `$limit`, `$lookup`, `$match`, `$merge`, `$project`, `$redact`, `$replaceRoot`, `$replaceWith`, `$sample`, `$set`, `$setWindowFields`, `$skip`, `$sort`, `$sortByCount`, `$unionWith`, `$unset`, `$unwind`
...
- `supportedStages`: `$addFields`, `$bucket`, `$bucketAuto`, `$collStats`, `$count`, `$currentOp`, `$densify`, `$documents`, `$facet`, `$fill`, `$geoNear`, `$group`, `$indexStats`, `$limit`, `$lookup`, `$match`, `$merge`, `$project`, `$redact`, `$replaceRoot`, `$replaceWith`, `$sample`, `$set`, `$setWindowFields`, `$skip`, `$sort`, `$sortByCount`, `$unionWith`, `$unset`, `$unwind`
