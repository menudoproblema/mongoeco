...
class FilteringHelperTests(unittest.TestCase):
    ...
    def test_query_engine_fast_comparison_paths_cover_scalar_and_array_branches(self):
        ...
        self.assertTrue(QueryEngine._query_equality_matches(3, 3.0, null_matches_undefined=False))
    ...
    def test_comparison_helpers_cover_numeric_fast_paths_and_candidate_expansion(self):
        ...
        self.assertTrue(QueryEngine._match_top_level_comparison({"score": 2.0}, "score", 1, "gt"))
        self.assertTrue(QueryEngine._match_top_level_comparison({"score": 2.0}, "score", 2, "gte"))
        self.assertTrue(QueryEngine._match_top_level_comparison({"score": 2.0}, "score", 3, "lt"))
        ...
        self.assertTrue(QueryEngine._match_top_level_comparison({"values": [2]}, "values", [1], "gt"))
