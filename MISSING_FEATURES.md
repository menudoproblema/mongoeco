...
| 19        | Window functions avanzadas restantes en `$setWindowFields` (`derivative`, `expMovingAvg`, `integral`, `locf`, `linearFill`) | Medio       | Medio-Alto  | `test_aggregation_expression_basics.py:745`                      |
