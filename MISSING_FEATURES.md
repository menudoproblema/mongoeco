...
| 11        | Features Atlas-like avanzadas sobre `$search` textual local (`facet`, `highlight`, `count`, semantica mas rica de `autocomplete`/`wildcard`/`regex`) | Medio-Alto  | Medio-Alto  | `search.py:126`<br>`TODO.md:10`                                   |
