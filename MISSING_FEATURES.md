...
| --------- | ----------------------------------------------------------------- | ----------- | ----------- | ----------------------------------------------------------------- |
| 11        | Ir mas alla del subset avanzado local de `$search` hacia paridad Atlas-like real (`searchMeta`/`facet` mas alla del preview local, highlighting mas rico, count meta, semantica mas rica de `autocomplete`/`wildcard`/`regex`) | Medio-Alto  | Medio-Alto  | `search.py:126`<br>`TODO.md:10`                                   |
